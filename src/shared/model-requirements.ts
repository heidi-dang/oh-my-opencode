...
const DEFAULT_AGENT_MODEL_REQUIREMENTS: Record<string, ModelRequirement> = {
  ...
  heidi: {
    fallbackChain: [
      ...
      { providers: ["google", "github-copilot", "opencode"], model: "gemini-1.5-flash" },
      { providers: ["opencode"], model: "minimax-m2.5-free" },
      { providers: ["ollama", "openai-compatible"], model: "llama3.2:latest" },
      { providers: ["ollama", "openai-compatible"], model: "qwen2.5:latest" },
      { providers: ["ollama", "openai-compatible"], model: "deepseek-coder:latest" },
      { providers: ["ollama", "openai-compatible"], model: "codellama:latest" },
      { providers: ["ollama", "openai-compatible"], model: "qwen3:8b" },
    ],
    requiresAnyModel: true,
  },
  "sisyphus-junior": {
