...
const VALID_TRANSITIONS: Record<TaskState, TaskState[]> = {
  ...
  EXECUTING: ["VERIFYING", "WAITING_FOR_EDIT_REVIEW", "WAITING_FOR_BACKGROUND_PROCESS", "STALL_DETECTED", "BLOCKED"],
  WAITING_FOR_EDIT_REVIEW: ["EXECUTING", "VERIFYING", "STALL_DETECTED", "BLOCKED"],
  WAITING_FOR_BACKGROUND_PROCESS: ["EXECUTING", "VERIFYING", "STALL_DETECTED", "BLOCKED"],
  VERIFYING: ["REPAIRING", "STALL_DETECTED", "BLOCKED"],
  REPAIRING: ["EXECUTING", "VERIFYING", "STALL_DETECTED", "BLOCKED"],
  STALL_DETECTED: ["AUTO_RECOVERING", "BLOCKED"],
  AUTO_RECOVERING: ["EXECUTING", "VERIFYING", "REPAIRING", "WAITING_FOR_EDIT_REVIEW", "WAITING_FOR_BACKGROUND_PROCESS", "SUBAGENT_DEBUGGING", "BLOCKED"],
  SUBAGENT_DEBUGGING: ["EXECUTING", "VERIFYING", "REPAIRING", "BLOCKED"],
  DONE: ["NEW"],
