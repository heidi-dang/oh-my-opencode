...
describe("message.part.delta handling", () => {
  ...
  it("renders agent header using profile hex color when available", () => {
    ...
    expect(rendered).toContain("claude-sonnet-4-6 (max)")
    ...
    const events: EventPayload[] = [
      {
        type: "message.updated",
        properties: {
          info: { sessionID: "ses_main", role: "assistant", agent: "Sisyphus (Ultraworker)", modelID: "claude-sonnet-4-6" },
        },
      },
      {
        type: "message.part.updated",
    ...
    const events: EventPayload[] = [
      {
        type: "message.updated",
        properties: {
          info: { id: "msg_assistant", sessionID: "ses_main", role: "assistant", agent: "Sisyphus (Ultraworker)", modelID: "claude-sonnet-4-6" },
        },
      },
      {
        type: "message.part.updated",
    ...
    const events: EventPayload[] = [
      {
        type: "message.updated",
        properties: {
          info: { id: "msg_assistant", sessionID: "ses_main", role: "assistant", agent: "Sisyphus (Ultraworker)", modelID: "claude-sonnet-4-6", variant: "max" },
        },
      },
      {
        type: "message.part.delta",
    ...
    const events: EventPayload[] = [
      {
        type: "message.updated",
        properties: {
          info: { id: "msg_user", sessionID: "ses_main", role: "user", agent: "Sisyphus (Ultraworker)", modelID: "claude-sonnet-4-6" },
        },
      },
      {
        type: "message.part.updated",
    ...
    const events: EventPayload[] = [
      {
        type: "message.updated",
        properties: {
          info: { id: "msg_1", sessionID: "ses_main", role: "assistant", agent: "Sisyphus", modelID: "claude-sonnet-4-6" },
        },
      },
      {
        type: "message.part.delta",
